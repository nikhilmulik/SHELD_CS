...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`chat_id`),
  KEY `profilechat u_id_idx` (`u_id`),
  CONSTRAINT `loginchat u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `credit_card` (
  ...
  KEY `logincc u_id_idx` (`u_id`),
  CONSTRAINT `logincc u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `feature` (
  ...
  KEY `loginfeature u_id_idx1` (`u_id`),
  CONSTRAINT `loginfeature u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `invoice` (
  ...
  KEY `logininvoice u_id_idx` (`u_id`),
  CONSTRAINT `logininvoice u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `keylog` (
  ...
  KEY `keyloglogin u_id_idx` (`u_id`),
  CONSTRAINT `keyloglogin u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login` (
  `u_id` varchar(50) NOT NULL DEFAULT 'Auto_Increment',
...
CREATE TABLE `smart_lock` (
  ...
  KEY `smart_lock_login u_id_idx` (`u_id`),
  ...
  CONSTRAINT `smart_lock_login u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_profile` (
  ...
  KEY `u_id_idx` (`u_id`),
  CONSTRAINT `loginu_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `webcam_capture` (
  ...
  KEY `login u_id_idx` (`u_id`),
  CONSTRAINT `login u_id` FOREIGN KEY (`u_id`) REFERENCES `login` (`u_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-15 10:30:04
